                  ...
                  <tbody>
                      ...
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <div class="product-box border">
                            <img src="{{ asset('dashboard/asset/images/products/11.png') }}" alt="">
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <div class="product-box border">
                            <img src="{{ asset('dashboard/asset/images/products/07.png') }}" alt="">
                          </div>
                          <div class="product-info">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <div class="product-box border">
                            <img src="{{ asset('dashboard/asset/images/products/17.png') }}" alt="">
                          </div>
                          <div class="product-info">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <div class="product-box border">
                            <img src="{{ asset('dashboard/asset/images/products/04.png') }}" alt="">
                          </div>
                          <div class="product-info">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <div class="product-box border">
                            <img src="{{ asset('dashboard/asset/images/products/10.png') }}" alt="">
                          </div>
                          <div class="product-info">
            ...
            <div class="card-body p-0">
              <div class="best-product p-2 mb-3">
                <div class="best-product-item">
                  <div class="d-flex align-items-center gap-3">
                    <div class="product-box border">
                        <img src="{{ asset('dashboard/asset/images/products/01.png') }}" alt="">
                    </div>
                ...
                <div class="best-product-item">
                  <div class="d-flex align-items-center gap-3">
                    <div class="product-box border">
                      <img src="{{ asset('dashboard/asset/images/products/02.png') }}" alt="">
                    </div>
                    <div class="product-info flex-grow-1">
                    <div class="progress-wrapper">
                      <div class="progress" style="height: 5px;">
                ...
                <div class="best-product-item">
                  <div class="d-flex align-items-center gap-3">
                    <div class="product-box border">
                      <img src="{{ asset('dashboard/asset/images/products/03.png') }}" alt="">
                    </div>
                    <div class="product-info flex-grow-1">
                    <div class="progress-wrapper">
                      <div class="progress" style="height: 5px;">
                ...
                <div class="best-product-item">
                  <div class="d-flex align-items-center gap-3">
                    <div class="product-box border">
                      <img src="{{ asset('dashboard/asset/images/products/05.png') }}" alt="">
                    </div>
                    <div class="product-info flex-grow-1">
                    <div class="progress-wrapper">
                      <div class="progress" style="height: 5px;">
                ...
                <div class="best-product-item">
                  <div class="d-flex align-items-center gap-3">
                    <div class="product-box border">
                      <img src="{{ asset('dashboard/asset/images/products/06.png') }}" alt="">
                    </div>
                    <div class="product-info flex-grow-1">
                    <div class="progress-wrapper">
                      <div class="progress" style="height: 5px;">
                ...
                <div class="best-product-item">
                  <div class="d-flex align-items-center gap-3">
                    <div class="product-box border">
                      <img src="{{ asset('dashboard/asset/images/products/08.png') }}" alt="">
                    </div>
                    <div class="product-info flex-grow-1">
                    <div class="progress-wrapper">
                      <div class="progress" style="height: 5px;">
