...
<head>
    ...
    <!--plugins-->
    <link href="{{ asset('dashboard/asset/plugins/simplebar/css/simplebar.css') }}" rel="stylesheet" />
    <link href="{{ asset('dashboard/asset/plugins/perfect-scrollbar/css/perfect-scrollbar.css') }}" rel="stylesheet" />
    <link href="{{ asset('dashboard/asset/plugins/metismenu/css/metisMenu.min.css') }}" rel="stylesheet" />
    <!-- Bootstrap CSS -->
    ...
    <!--Theme Styles-->
    <link href="{{ asset('dashboard/asset/css/dark-theme.css') }}" rel="stylesheet" />
    <link href="{{ asset('dashboard/asset/css/light-theme.css') }}" rel="stylesheet" />
    <link href="{{ asset('dashboard/asset/css/semi-dark.css') }}" rel="stylesheet" />
    <link href="{{ asset('dashboard/asset/css/header-colors.css') }}" rel="stylesheet" />
    <link href="{{ asset('dashboard/asset/css/header-colors.css') }}" rel="stylesheet" />
...
<body>
    ...
    <div class="wrapper">
                            ...
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                                ...
                                <div class="user-setting d-flex align-items-center">
                                    @php
                                        ...
                                        $imagePath = asset("uploads/$type/$image");
                                    @endphp
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <small
                                                    class="mb-0 dropdown-user-designation text-secondary">{{ $permission }}</small>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item dropdown dropdown-large">
                            ...
                            <div class="dropdown-menu dropdown-menu-end p-0">
                                ...
                                <div class="header-message-list p-2">
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('dashboard/asset/images/avatars/avatar-1.png') }}"
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('dashboard/asset/images/avatars/avatar-2.png') }}"
                                                alt="" class="rounded-circle" width="50" height="50">
                                            <div class="ms-3 flex-grow-1">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('dashboard/asset/images/avatars/avatar-3.png') }}"
                                                alt="" class="rounded-circle" width="50" height="50">
                                            <div class="ms-3 flex-grow-1">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('dashboard/asset/images/avatars/avatar-4.png') }}"
                                                alt="" class="rounded-circle" width="50" height="50">
                                            <div class="ms-3 flex-grow-1">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('dashboard/asset/images/avatars/avatar-5.png') }}"
                                                alt="" class="rounded-circle" width="50" height="50">
                                            <div class="ms-3 flex-grow-1">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('dashboard/asset/images/avatars/avatar-6.png') }}"
                                                alt="" class="rounded-circle" width="50" height="50">
                                            <div class="ms-3 flex-grow-1">
        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div>
                    <img src="{{ asset('dashboard/asset/images/logo-icon.png') }}" class="logo-icon"
                        alt="logo icon">
                </div>
                <div>
            ...
            @include('dashboard.light.sidebar')
    ...
    <script src="{{ asset('dashboard/asset/plugins/chartjs/js/Chart.min.js') }}"></script>
    <script src="{{ asset('dashboard/asset/plugins/chartjs/js/Chart.extension.js') }}"></script>
    <!--app-->
    <script src="{{ asset('dashboard/asset/js/app.js') }}"></script>
    <script src="{{ asset('dashboard/asset/js/index.js') }}"></script>
