  ...
  <div class="wrapper">
       ...
       <header>
          <nav class="navbar navbar-expand-lg navbar-light bg-white rounded-0 border-bottom">
            <div class="container">
              <a class="navbar-brand" href="#"><img src="{{ asset('dashboard/asset/images/brand-logo-2.png') }}" width="140" alt=""/></a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="d-flex ms-3 gap-3">
                  ...
                  <a href="{{ route('register') }}" class="btn btn-primary btn-sm px-4 radius-30">Register</a>
                </div>
              </div>
            </div>
          </nav>
            ...
            <div class="card rounded-0 overflow-hidden shadow-none bg-white border">
              <div class="row g-0">
                <div class="col-12 order-1 col-xl-8 d-flex align-items-center justify-content-center border-end">
                  <img src="{{ asset('dashboard/asset/images/error/auth-img-register3.png') }}" class="img-fluid" alt="">
                </div>
