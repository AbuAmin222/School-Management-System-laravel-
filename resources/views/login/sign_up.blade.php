...
<body>
            ...
            <div class="card shadow rounded-0 overflow-hidden">
              <div class="row g-0">
                <div class="col-lg-6 bg-login d-flex align-items-center justify-content-center">
                  <img src="{{ asset('dashboard/asset/images/error/login-img.jpg') }}" class="img-fluid" alt="">
                </div>
                <div class="col-lg-6">
                    ...
                    <form class="form-body">
                      <div class="d-grid">
                        <a class="btn btn-white radius-30" href="javascript:;"><span class="d-flex justify-content-center align-items-center">
                            <img class="me-2" src="{{ asset('dashboard/asset/images/icons/search.svg') }}" width="16" alt="">
  ...
  <!--plugins-->
  <script src="{{ asset('dashboard/asset/js/jquery.min.jpg') }} "></script>
  <script src="{{ asset('dashboard/asset/js/pace.min.jpg') }} "></script>
